...
const TEXTURE_TALL_CENTER: Texture2D = preload("res://assets/main/nurikabe/sprites/cursor_tall_center.png")
const TEXTURE_TALL_OUTLINE: Texture2D = preload("res://assets/main/nurikabe/sprites/cursor_tall_outline.png")
const TEXTURE_CENTER: Texture2D = preload("res://assets/main/nurikabe/sprites/cursor_center.png")
const TEXTURE_OUTLINE: Texture2D = preload("res://assets/main/nurikabe/sprites/cursor_outline.png")
