...
var _cursors_by_monster: Dictionary[Monster, Node2D] = {}
...
func _process(_delta: float) -> void:
	for monster: Monster in _cursors_by_monster:
		update_cursor(monster)


func add_cursor(monster: Monster) -> void:
