...
const TEXTURE_OUTLINE: Texture2D = preload("res://assets/main/nurikabe_3d/cursor_outline_cursor_outline.png")
const TEXTURE_CENTER: Texture2D = preload("res://assets/main/nurikabe_3d/cursor_center_cursor_center.png")
