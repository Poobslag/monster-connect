...
var game_board: NurikabeGameBoard3D = null
...
var _last_cursor_3d_pos: Vector3 = Vector3.ZERO
...
func handle(event: InputEvent) -> void:
	...
	if _input_sfx:
		SoundManager.play_sfx_at_3d(_input_sfx, _get_global_cursor_3d_position())
...
func _handle_lmb_press() -> void:
	_last_cursor_3d_pos = _get_global_cursor_3d_position()
...
func _handle_mb_drag() -> void:
	var cells: Array[Vector2i] = _get_cells_along_line(_last_cursor_3d_pos, _get_global_cursor_3d_position())
...
func _get_cells_along_line(from_pos: Vector3, to_pos: Vector3) -> Array[Vector2i]:
	...
	if game_board.has_half_cells(monster.id):
		if _last_set_cell_to == CELL_WALL:
			...
			if _last_set_cell_from == CELL_WALL:
				SoundManager.play_sfx_at_3d("drop_wall_press", _get_global_cursor_3d_position())
			elif _last_set_cell_from == CELL_ISLAND:
				SoundManager.play_sfx_at_3d("drop_island_press", _get_global_cursor_3d_position())
...
func _cursor_cell() -> Vector2i:
	return _get_cell_from_position(_get_global_cursor_3d_position())


func _get_cell_from_position(pos: Vector3) -> Vector2i:
	return game_board.global_to_map(pos)


func _get_global_cursor_3d_position() -> Vector3:
	return monster.cursor_3d.global_position
