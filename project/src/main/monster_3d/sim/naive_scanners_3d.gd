...
class AdjacentIslandScanner extends NaiveScanner3D:
...
class CheatScanner extends NaiveScanner3D:
...
class IslandMoatScanner extends NaiveScanner3D:
...
class IslandExpansionScanner extends NaiveScanner3D:
	var next_island_index: int = 0
...
class PoolScanner extends NaiveScanner3D:
...
class UnreachableScanner extends NaiveScanner3D:
...
class WallExpansionScanner extends NaiveScanner3D:
	var next_wall_index: int = 0
