...
const DEDUCTION_DELAYS_MIN: Dictionary[Deduction.Reason, float] = {
	...
	ISLAND_BUFFER: 5.4,
	ISLAND_CHAIN: 5.4,
	ISLAND_CHAIN_BUFFER: 5.4,
	ISLAND_CHOKEPOINT: 5.4,
	ISLAND_CONNECTOR: 5.4,
	ISLAND_SNUG: 5.4,
	POOL_CHOKEPOINT: 5.4,
	UNCLUED_LIFELINE: 5.4,
	...
	ASSUMPTION: 10.8,
	BORDER_HUG: 10.8,
	ISLAND_BATTLEGROUND: 10.8,
	ISLAND_RELEASE: 10.8,
	ISLAND_STRANGLE: 10.8,
	WALL_STRANGLE: 10.8,
}
...
const DEDUCTION_DELAYS_MAX: Dictionary[Deduction.Reason, float] = {
	...
	ISLAND_BUFFER: 18.0,
	ISLAND_CHAIN: 18.0,
	ISLAND_CHAIN_BUFFER: 18.0,
	ISLAND_CHOKEPOINT: 18.0,
	ISLAND_CONNECTOR: 18.0,
	ISLAND_SNUG: 18.0,
	POOL_CHOKEPOINT: 18.0,
	UNCLUED_LIFELINE: 18.0,
	...
	ASSUMPTION: 60.0,
	BORDER_HUG: 60.0,
	ISLAND_BATTLEGROUND: 60.0,
	ISLAND_RELEASE: 60.0,
	ISLAND_STRANGLE: 60.0,
	WALL_STRANGLE: 60.0,
}
