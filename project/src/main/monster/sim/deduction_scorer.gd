...
const DEDUCTION_DELAY_FOR_REASON: Dictionary[Deduction.Reason, float] = {
	...
	ISLAND_BUFFER: 3.6,
	ISLAND_CHAIN: 3.6,
	ISLAND_CHAIN_BUFFER: 3.6,
	ISLAND_CHOKEPOINT: 3.6,
	ISLAND_CONNECTOR: 3.6,
	ISLAND_SNUG: 3.6,
	POOL_CHOKEPOINT: 3.6,
	UNCLUED_LIFELINE: 3.6,
	UNCLUED_LIFELINE_BUFFER: 3.6,
	UNREACHABLE_CELL: 3.6,
	WALL_CONNECTOR: 3.6,
	WALL_WEAVER: 3.6,
