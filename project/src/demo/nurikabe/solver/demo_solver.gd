...
extends Node
## [b]Keys:[/b][br]
## 	[kbd]Q[/kbd]: Solve one step.[br]
## 	[kbd]Shift + Q[/kbd]: Solve five steps.[br]
## 	[kbd]W[/kbd]: Performance test a full solution.[br]
## 	[kbd]E[/kbd]: Solve until bifurcation is necessary.[br]
## 	[kbd]R[/kbd]: Reset the board.[br]
## 	[kbd]O[/kbd]: Print memory usage statistics.[br]
## 	[kbd]P[/kbd]: Print fpartially solved puzzle to console.[br]
## 	[kbd]Shift + P[/kbd]: Print available probes and bifurcation scenarios to console.[br]
## 	[kbd]D[/kbd]: Print the puzzle's measured difficulty.[br]
## 	[kbd]F[/kbd]: Print the puzzle's fun.[br]
## 	[kbd]H[/kbd]: Clear the solver history. Forces deductions to be rerun.[br]
## 	[kbd]B[/kbd]: Print benchmark results for AggregateTimer/SplitTimer.[br]
## 	[kbd]Mouse[/kbd]: Middle-drag to pan, scroll to zoom.[br]
##
## [b]Commands:[/b][br]
## 	[kbd]/j<n>[/kbd]: Load Janko puzzle <n>.[br]
## 	[kbd]/n<n>[/kbd]: Load Nikoli puzzle <n>.[br]
## 	[kbd]/p<n>[/kbd]: Load Poobslag puzzle <n>.[br]
## 	[kbd]/w<n>[/kbd]: Performance test the next <n> puzzles in sequence.[br]
