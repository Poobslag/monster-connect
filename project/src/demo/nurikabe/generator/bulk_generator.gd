class_name BulkGenerator3D
extends Node
## [b]Keys:[/b][br]
## 	[kbd]O[/kbd]: Print memory usage statistics.[br]
## 	[kbd]G[/kbd]: Toggle generator, continuously writes new puzzles to GENERATED_PUZZLE_DIR.[br]
## 	[kbd]A[/kbd]: Toggle analyzer; analyzes puzzles in PUZZLE_DIR and writes .info files.[br]
## 	[kbd]C[/kbd]: Compact; delete 25% of the oldest puzzles and renumber the remaining ones.[br]
