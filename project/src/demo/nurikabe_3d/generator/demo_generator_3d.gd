extends Node
## [b]Keys:[/b][br]
## 	[kbd][1-8][/kbd]: Set puzzle size.[br]
## 	[kbd]W[/kbd]: Completely solve a puzzle.[br]
## 	[kbd]R[/kbd]: Clear the board.[br]
## 	[kbd]O[/kbd]: Print memory usage statistics.[br]
## 	[kbd]P[/kbd]: Print partially solved puzzle to console.[br]
## 	[kbd]S[/kbd]: Assign fixed seed.[br]
## 	[kbd]Shift + S[/kbd]: Increment fixed seed.[br]
## 	[kbd]D[/kbd]: Increase target difficulty.[br]
## 	[kbd]Shift + D[/kbd]: Decrease target difficulty.[br]
## 	[kbd]G[/kbd]: Generate one step.[br]
## 	[kbd]Shift + G[/kbd]: Generate five steps.[br]
## 	[kbd]H[/kbd]: Completely generate a puzzle.[br]
...
func _input(event: InputEvent) -> void:
	...
	match Utils.key_press(event):
		...
		KEY_D:
			...
			_log_message("target_difficulty: %s" % [generator.difficulty])
		KEY_M:
