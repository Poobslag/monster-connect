...
func test_get_neighbor_groups_one() -> void:
	load_grid([
		"1  ",
		"2  ",
		"  3",
	])
	assert_groups(guf.get_neighbor_groups(Vector2i(1, 1)), [
			[Vector2i(0, 0), Vector2i(0, 1)],
		])


func test_get_neighbor_groups_two() -> void:
	load_grid([
		"1  ",
		"2 3",
		"  4",
...
func test_get_neighbor_groups_duplicate() -> void:
	load_grid([
		"13 ",
		"2  ",
		"   ",
