...
func test_create_island_chokepoint_probes_snug() -> void:
	grid = [
		" .    ",
		" 5    ",
		"  ####",
...
func test_create_island_probes_corner_island() -> void:
	...
	assert_deductions(solver.create_island_probes, expected)


func test_create_island_probes_island_expansion_1() -> void:
	grid = [
		" 4    ",
		"####  ",
		"      ",
...
func test_create_island_probes_island_expansion_and_moat() -> void:
	grid = [
		" 2    ",
		"##    ",
		"      ",
...
func test_create_island_probes_island_connector() -> void:
	grid = [
		"     6",
		"##    ",
		" .    ",
...
func test_create_island_probes_island_moat() -> void:
	grid = [
		" 2    ",
		" .    ",
		"      ",
...
func test_create_island_probes_island_snug() -> void:
	grid = [
		"   4  ",
		"####  ",
	]
...
func test_create_island_probes_corner_buffer_1() -> void:
	grid = [
		"            ",
		"    ########",
		"15  ## 6 . .",
...
func test_create_island_probes_corner_buffer_2() -> void:
	grid = [
		"            ",
		"    ########",
		"15  ## . . .",
...
func test_create_unreachable_square_probes_1() -> void:
	grid = [
		" 4    ",
		"      ",
		"      ",
	...
	assert_deductions(solver.create_unreachable_square_probes, expected)


func test_create_unreachable_square_probes_2() -> void:
	grid = [
		" 4##  ",
		" .    ",
		"      ",
...
func test_create_unreachable_square_probes_3() -> void:
	grid = [
		"   .    ",
		"    ## 2",
		" . 7   .",
...
func test_create_unreachable_square_probes_blocked() -> void:
...
func test_create_unreachable_square_probes_wall_bubble() -> void:
	grid = [
		" 3  ######  ",
		"  ####      ",
		"## 1## 2##  ",
...
func test_create_wall_probes_pool_triplet_1() -> void:
	...
	assert_deductions(solver.create_wall_probes, expected)
...
func test_create_wall_probes_pool_triplets_invalid_1() -> void:
	grid = [
		" 3#### 3",
		"        ",
		"  ####  ",
...
func test_create_wall_probes_pool_triplets_invalid_2() -> void:
	grid = [
		"##########",
		"## 1## 1##",
		"####  ####",
...
func test_create_wall_probes_wall_expansion_1() -> void:
	grid = [
		"## 4  ",
		"      ",
		"    ##",
